 ...
 * @author Sonam
 */
public class ManagePublisherUserAccountsJPanel extends javax.swing.JPanel {
    ...
    public ManagePublisherUserAccountsJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Publisher User Account's");
    ...
    private void addUserAccountJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUserAccountJButtonActionPerformed
        // TODO add your handling code here:
        AddPublisherUserAccountsJPanel aauajp = new AddPublisherUserAccountsJPanel(userProcessContainer, organizationDirectory,ecoSystem);
        userProcessContainer.add("AddPublisherUserAccountsJPanel", aauajp);
    ...
    private void enableDisableUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enableDisableUserJButtonActionPerformed
        ...
        if (ua.getIsActive().equalsIgnoreCase("Yes")) {
            ...
            if (flag == JOptionPane.YES_OPTION) {
                ua.setIsActive("No");
                System.out.println("User account marked inactive");
            }
            ...
            if (flag == JOptionPane.YES_OPTION) {
                ua.setIsActive("Yes");
                System.out.println("User account marked active");
            }
        }
        refreshTable(org);
