 ...
 * @author Sonam
 */
public class AddCustomerUserAccountJPanel extends javax.swing.JPanel {
    ...
    public AddCustomerUserAccountJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDirectory,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Add Customer User Account");
    ...
    private void addUserAccountJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUserAccountJButtonActionPerformed
        ...
        {
            ua=org.getUserAccountDirectory().createUserAccount(userNameJTextField.getText(),passwordJTextField.getText(),(Advertiser)person,role);
        }else if (role instanceof PublisherRole)
        {
            ua=org.getUserAccountDirectory().createUserAccount(userNameJTextField.getText(),passwordJTextField.getText(),(Publisher)person,role);
        }else if (role instanceof CustomerRole)
        {
            ua=org.getUserAccountDirectory().createUserAccount(userNameJTextField.getText(),passwordJTextField.getText(),(Customer)person,role);
        }
        ...
        System.out.println("User account created and details updated");
